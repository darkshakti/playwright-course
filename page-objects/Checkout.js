...
export class Checkout {
    ...
    constructor(page){
        ...
        this.contitueToCheckoutButton = page.locator('[data-qa="continue-to-checkout"]');
...
continueToCheckout = async () => {
    await this.contitueToCheckoutButton.waitFor();
    await this.contitueToCheckoutButton.click();
